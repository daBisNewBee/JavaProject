...
class P_160_IntersectionOfTwoLinkedLists {
...
class Solution {
    fun getIntersectionNode(headA: ListNode?, headB:ListNode?):ListNode? {
        ...
        while (p1 != p2) {
            ...
            // 只是单纯的控制行进方向，并不会改变链表中节点的真实指针！！否则会形成死循环
    ...
    // 想想为什么这么写不行？改变了真实指针，有死循环了

    fun getIntersectionNode_wrong(headA: ListNode?, headB:ListNode?):ListNode? {
